...
| 1.2 | 2025-02-05 | 功能清單狀態更新、驗收標準細化 | |
| 1.3 | 2025-02-09 | 非功能需求補充、UI 規格調整 | |
...
│  │  分段列表                                        總週期: 45.2s  │   │
│  │  ┌─────────────────────────────────────────────────────────┐   │   │
│  │  │  = 取料    │  0.0s - 8.5s   │  8.5s   │  [編輯] [刪除]  │   │   │
│  │  │  = 定位    │  8.5s - 12.3s  │  3.8s   │  [編輯] [刪除]  │   │   │
│  │  │  = 組裝    │  12.3s - 35.6s │  23.3s  │  [編輯] [刪除]  │   │   │
│  │  │  = 檢查    │  35.6s - 42.1s │  6.5s   │  [編輯] [刪除]  │   │   │
│  │  │  = 放置    │  42.1s - 45.2s │  3.1s   │  [編輯] [刪除]  │   │   │
│  │  └─────────────────────────────────────────────────────────┘   │   │
│  └─────────────────────────────────────────────────────────────────┘   │
│                                                                         │
│                                         [ 儲存變更 ]  [ 重新分析 ]     │
