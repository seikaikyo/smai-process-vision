...
**推薦方案 A 理由**：
- 關鍵工站用 MIC-730AI，處理效能足夠
- 一般工站用 MIC-720AI，降低成本
- 總處理能力充裕，有擴充空間
...
1. **效能平衡**: 關鍵工站用 MIC-730AI 處理複雜場景，一般工站用 MIC-720AI 省成本
2. **擴充彈性**: 28 路處理能力超過目前 20 路需求，有擴充空間
3. **成本效益**: 投資回收期約 6 個月，ROI 良好
4. **整合完整**: 可直接與 WISE-IoTSuite 整合，減少開發工作
